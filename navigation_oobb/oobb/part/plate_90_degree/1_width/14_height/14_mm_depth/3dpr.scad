...
difference() {
	...
	union() {
		translate(v = [-97.5, 0, -2.0]) {
			cylinder(h = 18.0, r = 3.25);
		}
		translate(v = [-90.0, 0, -2.0]) {
			cylinder(h = 18.0, r = 1.8);
		}
		translate(v = [-82.5, 9.0, 7.0]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 18.0, r = 3.25);
			}
		}
		translate(v = [-75.0, 9.0, 7.0]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 18.0, r = 1.8);
			}
		}
		...
		translate(v = [82.5, 0, -2.0]) {
			cylinder(h = 18.0, r = 3.25);
		}
		translate(v = [90.0, 0, -2.0]) {
			cylinder(h = 18.0, r = 1.8);
		}
		translate(v = [97.5, 9.0, 7.0]) {
			rotate(a = [90, 0, 0]) {
				cylinder(h = 18.0, r = 3.25);
			}
		}
